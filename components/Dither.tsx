...
// Dithered wave background, adapted from reactbits.dev/backgrounds/dither.
...
function DitheredWaves({
  ...
  useFrame((_state, delta) => {
    ...
    // Accumulate delta; the clock does not advance in this three/r3f combo.
...
export default function Dither({
  ...
  waveFrequency = 6.5,
  waveAmplitude = 0.4,
  waveColor = [0.2274509803921568, 0.2274509803921568, 0.2274509803921568],
  colorNum = 5,
  pixelSize = 2,
